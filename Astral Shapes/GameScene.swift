...
//
//  GameSceneAllInOne.swift
//  TheFinalShow
//
//  Created by Jordan Klein on 12/22/19.
//  Copyright © 2019 JordanKlein. All rights reserved.
//
...
//Defining Shape Collision types
enum CollisionType: UInt32 {
      case playerShape = 1
      case Shape1 = 2
      case everythingElse = 4
}
//Emitter
let disappear = SKEmitterNode(fileNamed: "Particle")!
// Defining Shapes and their colors for player
let triangleRed = SKSpriteNode(imageNamed: "triangleRed")
let triangleGreen = SKSpriteNode(imageNamed: "triangleGreen")
let triangleBlue = SKSpriteNode(imageNamed: "triangleBlue")
let triangleYellow = SKSpriteNode(imageNamed: "triangleYellow")
let triangleOrange = SKSpriteNode(imageNamed: "triangleOrange")
let trianglePurple = SKSpriteNode(imageNamed: "trianglePurple")
let circleRed = SKSpriteNode(imageNamed: "circleRed")
let circleGreen = SKSpriteNode(imageNamed: "circleGreen")
let circleBlue = SKSpriteNode(imageNamed: "circleBlue")
let circleYellow = SKSpriteNode(imageNamed: "circleYellow")
let circleOrange = SKSpriteNode(imageNamed: "circleOrange")
let circlePurple = SKSpriteNode(imageNamed: "circlePurple")
let squareRed = SKSpriteNode(imageNamed: "squareRed")
let squareGreen = SKSpriteNode(imageNamed: "squareGreen")
let squareBlue = SKSpriteNode(imageNamed: "squareBlue")
let squareYellow = SKSpriteNode(imageNamed: "squareYellow")
let squareOrange = SKSpriteNode(imageNamed: "squareOrange")
let squarePurple = SKSpriteNode(imageNamed: "squarePurple")
let hexagonRed = SKSpriteNode(imageNamed: "hexagonRed")
let hexagonGreen = SKSpriteNode(imageNamed: "hexagonGreen")
let hexagonBlue = SKSpriteNode(imageNamed: "hexagonBlue")
let hexagonYellow = SKSpriteNode(imageNamed: "hexagonYellow")
let hexagonOrange = SKSpriteNode(imageNamed: "hexagonOrange")
let hexagonPurple = SKSpriteNode(imageNamed: "hexagonPurple")

var playerShape = SKSpriteNode()
var Shape1 = SKSpriteNode()
// Defining Shapes and their colors for possible shapes
let triRed = SKSpriteNode(imageNamed: "triRed")
let triGreen = SKSpriteNode(imageNamed: "triGreen")
let triBlue = SKSpriteNode(imageNamed: "triBlue")
let triYellow = SKSpriteNode(imageNamed: "triYellow")
let triOrange = SKSpriteNode(imageNamed: "triOrange")
let triPurple = SKSpriteNode(imageNamed: "triPurple")

let ciRed = SKSpriteNode(imageNamed: "ciRed")
let ciGreen = SKSpriteNode(imageNamed: "ciGreen")
let ciBlue = SKSpriteNode(imageNamed: "ciBlue")
let ciYellow = SKSpriteNode(imageNamed: "ciYellow")
let ciOrange = SKSpriteNode(imageNamed: "ciOrange")
let ciPurple = SKSpriteNode(imageNamed: "ciPurple")

let sqRed = SKSpriteNode(imageNamed: "sqRed")
let sqGreen = SKSpriteNode(imageNamed: "sqGreen")
let sqBlue = SKSpriteNode(imageNamed: "sqBlue")
let sqYellow = SKSpriteNode(imageNamed: "sqYellow")
let sqOrange = SKSpriteNode(imageNamed: "sqOrange")
let sqPurple = SKSpriteNode(imageNamed: "sqPurple")

let hexRed = SKSpriteNode(imageNamed: "hexRed")
let hexGreen = SKSpriteNode(imageNamed: "hexGreen")
let hexBlue = SKSpriteNode(imageNamed: "hexBlue")
let hexYellow = SKSpriteNode(imageNamed: "hexYellow")
let hexOrange = SKSpriteNode(imageNamed: "hexOrange")
let hexPurple = SKSpriteNode(imageNamed: "hexPurple")


//Background Work
let background = SKSpriteNode(imageNamed: "background1")
//Defining position
let position1 = CGPoint(x: screenWidth/2, y: screenHeight * 0.8) // Top Shape!
let position2 = CGPoint(x: screenWidth-circleRed.size.width/2, y: screenHeight * 0.8) // Right Mid Shape!
let position3 = CGPoint(x: hexagonRed.size.width/2, y: screenHeight * 0.8) // Left Mid Shape!
let position4 = CGPoint(x: screenWidth/2, y: screenHeight * 0.6) // Bottom Shape!
let position5 = CGPoint(x: screenWidth-circleRed.size.width/2, y: screenHeight * 0.4) // Right Mid Bottom!
let position6 = CGPoint(x: screenWidth-circleRed.size.width/2, y: screenHeight * 0.6) // Right Mid Top!
let position7 = CGPoint(x: hexagonRed.size.width/2, y: screenHeight * 0.4) // Left Mid Bottom!
let position8 = CGPoint(x: hexagonRed.size.width/2, y: screenHeight * 0.6) // Left Mid Top!
let position9 = CGPoint(x: screenWidth/2, y: screenHeight * 0.4)
//Label Images
var countdown = 3 //CountDown for game start
//Scoring
var scoreAmount = SKLabelNode(fontNamed: "Press Start 2P")
var score = Int()
var totalTime = SKLabelNode(fontNamed: "Press Start 2P")
var seconds = 7.0
...
//Buttons/Labels
let mainMenuS = UIButton(type:.system) // sends the user back to the main menu
let scoreLabel = SKLabelNode(fontNamed: "Press Start 2P")
let scoreNumber = SKLabelNode(fontNamed: "Press Start 2P")
...
//        addChild(xpText)
    ...
    @objc func mainMenuScene(sender: UIButton!) { // sending the User back to the Game
        ...
        //score = someplaceholder // some placeholder will be checked throughout the array
        // adding high score!
    ...
    func startGame(){
        constantUpdate()// sets highscore and prints the score as well as the time left in intravels
